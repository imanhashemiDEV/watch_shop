...
@include('admin.partials.header',[$title=' ایجاد مشخصات محصول'])
@section('content')
    <!-- begin::main content -->
                ...
                <div class="container">
                    ...
                    <form method="post" action="{{route('properties.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">نام  مشخصات</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row" data-select2-id="23">
                            <label class="col-sm-2 col-form-label"> عنوان گروه بندی</label>
                            <div class="col-sm-10">
